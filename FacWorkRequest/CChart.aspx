<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="CChart.aspx.vb" Inherits="FacWorkRequest.CChart" %>
                            ...
                            callback: function() {
                                ...
                                var getDataRole1 = function() {
                                    ...
                                    $.ajax({
                                        ...
                                        url: '<%=ResolveUrl("~/WebService.asmx/getData_ChartSummaryByDept")%>',
                                ...
                                var getDataRoleTotal = function() {
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: 'json',
                                        contentType: 'application/json',
                                        url: '<%=ResolveUrl("~/WebService.asmx/getData_ChartSummaryByDeptTotal")%>',
                                    ...
                                    window.myMixedChart = new Chart(ctx,
                                        {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: '#On Progress Group-1# Remain By Division'
                                                },
                                                plugins: {
                                                    datalabels: {
                                                        display: false
                                    ...
                                    window.myMixedChart = new Chart(ctx,
                                        {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: '#On Progress Group-2# Remain By Division'
                                                },
                                                plugins: {
                                                    datalabels: {
                                                        display: false
                                    ...
                                    window.myMixedChart = new Chart(ctx,
                                        {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: '#On Progress Group-3# Remain By Division'
                                                },
                                                plugins: {
                                                    datalabels: {
                                                        display: false
                                    ...
                                    window.myMixedChart = new Chart(ctx,
                                        {
                                            ...
                                            options: {
                                                ...
                                                title: {
                                                    display: true,
                                                    text: 'Total Panding Remain By Division'
                                                },
                                                plugins: {
                                                    datalabels: {
                                                        display: false
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div class="jumbotron">
            <p class="text-danger">Quantity Job On Work</p>
