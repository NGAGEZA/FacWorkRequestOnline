...
Public Class RptWorkRequest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacWorkRequest.RptWorkRequest.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WRNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptWorkRequest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptWorkRequest = New RptWorkRequest()
        rpt.Site = Me.Site
        Return rpt
    End Function
