...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function(options, refreshMode) {
            ...
            self.$errorContainer =
                $h.getElement(options, "elErrorContainer", self.$previewContainer.find(".kv-fileinput-error"));
        ...
        _initPreviewTemplates: function() {
            ...
            $.each(self.previewContentTemplates,
                function(key, value) {
        ...
        _addError: function(msg) {
            ...
            if (msg && $error.length) {
                ...
                self._handler($error.find(".kv-error-close"),
                    "click",
                    function() {
                        setTimeout(function() {
        ...
        _setZoomContent: function($frame, animate) {
            ...
            self._handler($btnFull,
                "click",
                function() {
                    self._resizeZoomDialog(true);
                });
            self._handler($btnBord,
                "click",
                function() {
                    self._resizeZoomDialog(false);
                });
            self._handler($btnTogh,
                "click",
                function() {
                            ...
                            function() {
                                ...
                                if (len === 0 && chk === 0 && !hasThumb) {
                                    ...
                                    cap = n > 1
                                        ...
                                        : (filestack[0] ? self._getFileNames()[0] : "");
                                    self._setCaption(cap);
                                }
        ...
        _generatePreviewTemplate: function(cat,
            ...
            var self = this,
                ...
                config = screenW < 400
                    ? (self.previewSettingsSmall[cat] || self.defaults.previewSettingsSmall[cat])
            ...
            getContent = function(c, d, zoom, frameCss) {
                ...
                if (cat === "object" && !ftype) {
                    $.each(self.defaults.fileTypeSettings,
                        function(key, func) {
        ...
        _renderMain: function() {
            var self = this,
                ...
                preview = !self.showPreview
                    ? ""
                    : self._getLayoutTemplate("preview")
